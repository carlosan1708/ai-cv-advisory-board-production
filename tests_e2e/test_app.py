...
def test_home_and_synthetic_demo(page: Page) -> None:
    page.goto(BASE_URL)
    expect(page.get_by_role("heading", name="Compare your CV to a target role")).to_be_visible()
    ...
    assert page.evaluate("getComputedStyle(document.body).backgroundColor") == "rgb(246, 247, 251)"
